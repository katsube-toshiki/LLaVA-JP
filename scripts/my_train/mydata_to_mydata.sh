...
python $LLAVA_JP_HOME/train_llava.py \
    ...
    --pretrain_mm_mlp_adapter $LLAVA_JP_HOME/output_llava/checkpoints/pretrain-llava-jp-1.3b-v1.1-1022k/mm_projector.bin \
    ...
    --fp16 False \
    --bf16 True \
    --output_dir $LLAVA_JP_HOME/output_llava/checkpoints/finetune-llava-jp-1.3b-v1.1-1022k-to-1022k \
    --num_train_epochs 1 \

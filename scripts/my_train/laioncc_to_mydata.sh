...
python $LLAVA_JP_HOME/train_llava.py \
    ...
    --pretrain_mm_mlp_adapter $LLAVA_JP_HOME/output_llava/checkpoints/pretrain-llava-jp-1.3b-v1.1-laioncc/mm_projector.bin \
    --mm_projector_type mlp2x_gelu \
    --mm_vision_select_feature patch \
    --scales 1.0 0.5 \
    --data_path $COMMONCRAWL_HOME/data/output_json/llava_pretrain_1022k.json \
    ...
    --fp16 False \
    --bf16 True \
    --output_dir $LLAVA_JP_HOME/output_llava/checkpoints/finetune-llava-jp-1.3b-v1.1-laioncc-to-1022k \
    --num_train_epochs 1 \

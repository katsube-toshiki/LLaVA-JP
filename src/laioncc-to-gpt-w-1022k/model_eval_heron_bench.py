...
if __name__ == "__main__":
    ...
    # output file
    output_file = "/work/gn53/k75057/projects/LLaVA-JP/results/laioncc-to-gpt-w-1022k/heron_bench.jsonl"

    # vlmのモデルを読み込む
    parser = transformers.HfArgumentParser(
        (ModelArguments, DataArguments, TrainingArguments))
    model_args, data_args, training_args = parser.parse_args_into_dataclasses()
    model_path = '/work/gn53/k75057/projects/LLaVA-JP/output_llava/checkpoints/finetune-llava-jp-1.3b-v1.1-laioncc-to-gpt-w-1022k'
    ...
    with open(output_file, "w") as f:
        for question_data in tqdm(data_list):
            ...
            output_data = {
                ...
                "prompt": prompt,
                "answer_id": "",
                "model_id": "laioncc-to-gpt-w-1022k",
                "metadata": {},
                "text": output,
            }
